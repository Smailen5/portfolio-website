...
7. Crea con `bash -c 'gh issue create --repo Smailen5/portfolio-website --title "..." --label "<tipo>,<priorità>" --body-file <tmpfile>'`
...
6. Crea con `bash -c 'gh pr create --repo Smailen5/portfolio-website --base main --title "..." --label "<tipo>" --body-file <tmpfile>'`
...
| Label | Colore | Quando usarla |
|-------|--------|---------------|
| `high` | `#b60205` rosso | Da fare subito |
| `medium` | `#fbca04` arancione | Da fare nei prossimi giorni |
| `low` | `#0e8a16` verde | Quando si ha tempo |
